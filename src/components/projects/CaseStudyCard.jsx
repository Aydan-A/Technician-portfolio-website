...
export default function CaseStudyCard({ project }) {
  return (
    <article className="case-card" id={project.id}>
      <CaseImage project={project} />

      <div className="case-card-body">
        <div className="case-card-tags">
          <span className="case-card-tag-category">{project.category}</span>
        ...
        {project.meta?.length > 0 && (
          <ul className="case-card-meta">
            {project.meta.map((item) => (
              <li className="case-card-meta-item" key={item.label}>
